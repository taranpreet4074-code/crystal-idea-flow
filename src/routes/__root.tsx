...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StoryReel AI — AI YouTube Story Generator" },
      {
        name: "description",
        content:
          "Turn one idea into a full YouTube story: script, scene breakdown, narration and image & video prompts.",
      },
      { property: "og:title", content: "StoryReel AI — AI YouTube Story Generator" },
      {
        property: "og:description",
        content: "Turn one idea into a full YouTube story package in seconds.",
      },
